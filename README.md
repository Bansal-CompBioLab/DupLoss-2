...
Detailed instructions for compiling from source and for executing the program are available in the user manual. For reference, a copy of the user manual is available from this GitHub link: [DupLoss-2 user manual](https://github.com/Bansal-CompBioLab/DupLoss-2/blob/main/DupLoss-2_UserManual.pdf) 
